...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($doctorID) && !empty($date) && !empty($time)) {
        $message = bookAppointment($userID, $doctorID, $date, $time);
...
<head>
    ...
    <style>
        ...
        button {
            ...
            padding: 10px;
            margin-top: 10px;
            background-color:rgb(15, 43, 182);
            color: white;
            border: none;
            border-radius: 4px;
        ...
        <section>
            ...
            <ul>
                <?php foreach ($appointments as $appointment): ?>
                    <li>
                        <?php echo $appointment['booking_day'] . ' - ' . $appointment['doctor_fname'] . ' ' . $appointment['doctor_lname'] . ', ' . $appointment['booking_time']; ?>
                    </li>
                <?php endforeach; ?>
            </ul>
